...
def main():
    ...
    if DEBUG:
        ...
        maxQueries = 2000 # maximum number of allowed queries
        ...
        def getNeighbors(node):
            ...
            line = sys.stdin.readline().split()# the answer has the form 'numNeighbors neighbor1 weight1 neighbor2 weight2 ...'
            # we want to have a list of the form:#[ (neighbor1, weight1), (neighbor2, weight2) , ...]
    ...
    # We now compute the average edge weight of a bunch of random neighborhoods¨
    sumOfWeights = 0
    numEdges = 0
